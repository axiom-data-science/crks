	...
	public class DragPanel extends Panel
	{
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			if (isMinimized == false){
				...
				minShape.graphics.drawRect(unscaledWidth - 20, 12, 8, 8);
				
				// Draw min icon.
				minShape.graphics.lineStyle(2);
				minShape.graphics.beginFill(0xFFFFFF, 0.0);
				minShape.graphics.drawRect(unscaledWidth - 20, 18, 8, 2);
				titleBar.buttonMode = false;
				titleBar.removeEventListener(MouseEvent.MOUSE_DOWN, restorePanelSizeHandler);
				minShape.addEventListener(MouseEvent.MOUSE_DOWN, minPanelSizeHandler);
			...
			// Draw restore icon.
				...
				minShape.graphics.beginFill(0xFFFFFF, 0.0);
				minShape.graphics.drawRect(unscaledWidth - 20, 12, 8, 8);
				minShape.graphics.moveTo(unscaledWidth - 20, 15);
				minShape.graphics.lineTo(unscaledWidth - 12, 15);
				minShape.removeEventListener(MouseEvent.MOUSE_DOWN, minPanelSizeHandler);
				titleBar.buttonMode = true;
				titleBar.addEventListener(MouseEvent.MOUSE_DOWN, restorePanelSizeHandler);
			}
